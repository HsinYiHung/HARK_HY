...
# Relative risk aversion OK
CRRA = 2
# Discount factor
DiscFac = 0.95

# Survival probabilities using Cocco's Fortran code
n = 81
...
# Now we have 81 probabilities of death,
# for ages 19 to 99.

# Labor income-OK

# They assume its a polinomial of age. Here are the coefficients-the same as the second papaer
a=-2.170042+2.700381
b1=0.16818
b2=-0.0323371/10
b3=0.0019704/100

time_params = {'Age_born': 19, 'Age_retire': 65, 'Age_death': 100}-OK
...
# last working period-the same as the second paper
repl_fac = 0.68212
...
# Transitory and permanent shock standard deviation from the paper-ok
std_tran_shock = 0.1
std_perm_shock = 0.08
